...
/**
 * Servlet Filter implementation class Logeo
 */
@WebFilter({"/Registro", "/Login"})
public class Logeo implements Filter {
	 ...
	 private static final boolean debug = true;
	    ...
	    public void doFilter(ServletRequest request, ServletResponse response,
	        ...
	        if (String.valueOf(sesion.getAttribute("sesionID")).equals(String.valueOf(sesion.getId()))) {
	            ...
	            res.sendRedirect("/Practica2-Plataformas-Web/MiAgenda");
	    ...
	    public String toString() {
	        ...
	        StringBuffer sb = new StringBuffer("Logeo(");
